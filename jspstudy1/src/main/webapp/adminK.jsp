...
if (session.getAttribute("midx") != null){
	out.println("Lv.00 :"+session.getAttribute("memberNick")+"&nbsp"+"&nbsp"+"&nbsp"+"&nbsp"+"&nbsp"+"&nbsp"+"&nbsp"+"&nbsp");
...
<div class="MemberList"><a class="adminLink" href="<%=request.getContextPath() %>/member/memberList.do"> 회원목록</a></div>
</div>
</div>
